...
copywriting_monthly = Product.create(
	title: "copywriting Hacking Monthly", 
 	subtitle: "Crash Course", 
 	author: "Mattan Griffel", 
 	length: "6 months", 
 	author_image_name: "teacher-image.jpg", 
 	...
 	download_url: "https://s3.amazonaws.com/stripetestjoshua/JOSHua+LEDBETTER.docx", 
 	details: "You'll get a bunch of videos", 
 	description: %{<p>A copywriting hacker is a rare combination: someone with the right marketing and technical skills who can come up with clever marketing hacks and also track their results.</p>

 <p>In this talk, Mattan Griffel introduces you to the concept of copywriting Hacking and shares his favorite tips for getting started as a copywriting hacker.</p>
 <p><strong>What You'll Learn</strong></p>
 <ul class="no-indent">
